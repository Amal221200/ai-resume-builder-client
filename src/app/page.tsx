...
import { ArrowRight, AtomIcon, ChevronRight, Edit, Share2 } from "lucide-react";
    ...
    <>
      ...
      <section className="z-50 flex min-h-[70vh] items-center justify-center">
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
          <a href="#" className="mb-7 inline-flex items-center justify-between rounded-full bg-gray-100 px-1 py-1 pr-4 text-sm text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700" role="alert">
